...
- `./.opencode/commands/gsd/` will be wiped and replaced
- `./.opencode/get-shit-done/` will be wiped and replaced
- `./.opencode/agents/gsd-*` files will be replaced

Your custom files in other locations are preserved:
- Custom commands in `./.opencode/commands/your-stuff/` ✓
